// Written by Solaris using C# -- Altis life RPG Forums http://www.altisliferpg.com/user/25561-solaris/
// Concept by Paradox (closed account)
using System;
    ...
    public class Program
    {
        static void Main( string[] args )
        {
            ...
            try
            {
                ...
                while ( reader.Read() )
                {
                    // Adding our suspected players to a list to extract later
                    infos.suspectedPlayers[counter] = reader.GetString( "name" ) + ",";
                    infos.playerId[counter] = reader.GetString( "playerid" ) + ",";
                    infos.databaseId[counter] = reader.GetString( "id" ) + ","; // Not sure if this is the actual title of the column..?
